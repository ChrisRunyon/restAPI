...
CREATE TABLE IF NOT EXISTS oauth_consumer_registry (
   ...
   , foreign key (ocr_usa_id_ref) references users (userId)
       on update cascade
       on delete set null
) engine=InnoDB default charset=utf8;
...
CREATE TABLE IF NOT EXISTS oauth_consumer_token (
   ...
   , foreign key (oct_usa_id_ref) references users (userId)
       on update cascade
       on delete cascade
) engine=InnoDB default charset=utf8;
...
CREATE TABLE IF NOT EXISTS oauth_server_registry (
   ...
   , foreign key (osr_usa_id_ref) references users (userId)
       on update cascade
       on delete set null
) engine=InnoDB default charset=utf8;
...
CREATE TABLE IF NOT EXISTS oauth_server_token (
   ...
   , foreign key (ost_usa_id_ref) references users (userId)
       on update cascade
       on delete cascade
) engine=InnoDB default charset=utf8;
